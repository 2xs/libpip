...
uint32_t unmapPage(uint32_t part, uint32_t vaddr);
...
uint32_t viret(void);
uint32_t mappedInChild(uint32_t vad);
uint32_t deletePartition(uint32_t desc);
uint32_t collect(uint32_t part, uint32_t target);
